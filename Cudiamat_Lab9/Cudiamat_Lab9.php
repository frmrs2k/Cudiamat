...
<body>
    ...
    <?php
        ...
        function computePizzaTotal($pizzaMenu, $toppingsMenu, $pizza, $toppings, $qty) {
            $total = 0;
            if (isset($pizzaMenu[$pizza])){
                $total+=$pizzaMenu[$pizza];
            }

            foreach ($toppings as $top){
            if (isset($toppingsMenu[$top])){
                $total += $toppingsMenu[$top];
                }
            }
            return $total * $qty;
        }
            ...
            <div class="card">
                ...
                <?php
                    if (isset($_POST['order'])) {
                        ...
                        $grandTotal=computePizzaTotal($pizzaMenu, $toppingsMenu, $pizza, $toppings, $qty);
                        ...
                        if (!empty($toppings)) {
                            echo "<div class='summary-item'><span>Toppings:</span><span>" . implode(", ", $toppings) . "</span></div>";
                        } else {
                            echo "<div class='summary-item'><span>Toppings:</span><span>No toppings</span></div>";
                        }
            ...
            <div class="card full-width order-counter">
                ...
                <?php
                    if (isset($_POST['order'])) {
                        ...
                        for ($i = 1; $i <= $qty; $i++) {
                            echo "<div class='order-item'>Order #$i: $pizza with " . (empty($toppings) ? "no toppings" : implode(", ", $toppings)) . "</div>";
                        }
                    }
                ?>
            </div>
